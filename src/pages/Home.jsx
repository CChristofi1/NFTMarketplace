      ...
      <header className=" py-24  mb-12 w-full   infotropic">
        ...
        <div className="flex flex-col items-center mb-12">
          <div className="mb-16 text-white text-center">
            <h1 className="text-5xl text-black font-bold font-body mb-2">NFT Explorer</h1>
          ...
          <div className="flex flex-col items-center justify-center mb-4 w-2/6 gap-y-2 ">
            <input
              className="border rounded-sm focus:outline-none py-2 px-3 w-full shadow-md"
              value={owner}
              onChange={(e) => setOwner(e.target.value)}
              placeholder="Insert your wallet address"></input>
            <input
              className="focus:outline-none border rounded-sm py-2 px-3 w-full shadow-md"
